...
if("TRUE" STREQUAL "TRUE")
  set(te_SOURCE_PREFIX /home/yang/lakib/src/te)
  set(te_DEVEL_PREFIX /home/yang/lakib/devel)
  set(te_INSTALL_PREFIX "")
  set(te_PREFIX ${te_DEVEL_PREFIX})
else()
  set(te_SOURCE_PREFIX "")
  set(te_DEVEL_PREFIX "")
  set(te_INSTALL_PREFIX /home/yang/lakib/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'te' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'te' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yang/lakib/src/te/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT te_NUM_DUMMY_TARGETS)
      set(te_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::te::wrapped-linker-option${te_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR te_NUM_DUMMY_TARGETS "${te_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::te::wrapped-linker-option${te_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND te_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yang/lakib/devel/lib;/home/yang/lakib/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${te_dep}_FOUND)
      find_package(${te_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${te_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(te_EXPORTED_TARGETS ${${te_dep}_EXPORTED_TARGETS})
endforeach()
